...
感知链路按 signal intake、preprocess、detection、observation、track、awareness 的顺序执行；假目标和虚警从 detection artifact 阶段开始进入同构结构。

| # | 展示名 | Node | Owner output |
|---:|---|---|---|
| 40 | 信号传入 | `sense.signal.intake` | 内存 `device_received_signal_bucket` |
| 41 | 信号预处理 | `sense.signal.preprocess` | `shared.sense.signal`、可选 `shared.sense.signal_interest`、内存 `preprocessed_signal_observation_set` |
| 42 | 信号成检 | `sense.detection.from_signal` | 内存 `signal_detection_set` |
| 43 | 假警维护 | `sense.detection.artifact.update` | 内存 `artifact_detection_set` |
| 44 | 探测更新 | `sense.detection.update` | `shared.sense.detection`、内存 `postprocessed_detection_set` |
| 45 | 探测成观 | `sense.observation.from_detection` | 内存 `observation_candidate_set` |
| 46 | 观测更新 | `sense.observation.update` | `shared.sense.observation` |
| 47 | 航迹更新 | `sense.track.update` | `shared.sense.track` |
| 48 | 态势融合 | `sense.awareness.update` | 内存 `awareness_working_set` |
| 49 | 态势维护 | `sense.awareness.maintain` | `shared.sense.awareness` |
...
| 检查项 | 期望结果 |
|---|---|
| 执行序号 | `02-ordered-execution.md` 中第 40 项为 `sense.signal.intake` |
...
| 检查项 | 期望结果 |
|---|---|
| 执行序号 | `02-ordered-execution.md` 中第 41 项为 `sense.signal.preprocess` |
| Build | `xmake build test-l3-unified-entry` 通过 |
...
| 检查项 | 期望结果 |
|---|---|
| 执行序号 | `02-ordered-execution.md` 中第 42 项为 `sense.detection.from_signal` |
| Build | `xmake build test-l3-unified-entry` 通过 |
...
| Contract | 来源 | 是否必需 | 说明 |
|---|---|---|---|
| 输入集合 | 内存 `signal_detection_set` | 是 | 由统一入口按 ordered execution 准备。 |
...
| 检查项 | 期望结果 |
|---|---|
| 执行序号 | `02-ordered-execution.md` 中第 43 项为 `sense.detection.artifact.update` |
| Build | `xmake build test-l3-unified-entry` 通过 |
...
| 检查项 | 期望结果 |
|---|---|
| 执行序号 | `02-ordered-execution.md` 中第 44 项为 `sense.detection.update` |
| Build | `xmake build test-l3-unified-entry` 通过 |
...
| 检查项 | 期望结果 |
|---|---|
| 执行序号 | `02-ordered-execution.md` 中第 45 项为 `sense.observation.from_detection` |
| Build | `xmake build test-l3-unified-entry` 通过 |
...
| 检查项 | 期望结果 |
|---|---|
| 执行序号 | `02-ordered-execution.md` 中第 46 项为 `sense.observation.update` |
| Build | `xmake build test-l3-unified-entry` 通过 |
...
| 检查项 | 期望结果 |
|---|---|
| 执行序号 | `02-ordered-execution.md` 中第 47 项为 `sense.track.update` |
| Build | `xmake build test-l3-unified-entry` 通过 |
...
| 检查项 | 期望结果 |
|---|---|
| 执行序号 | `02-ordered-execution.md` 中第 48 项为 `sense.awareness.update` |
| Build | `xmake build test-l3-unified-entry` 通过 |
...
| 检查项 | 期望结果 |
|---|---|
| 执行序号 | `02-ordered-execution.md` 中第 49 项为 `sense.awareness.maintain` |
| Build | `xmake build test-l3-unified-entry` 通过 |
